...
with st.expander("📝 Thông tin chi tiết (SP, HĐ, Nguồn gốc...)", expanded=not st.session_state.header_locked):
    ...
    with col_new3:
        st.empty() # Placeholder for layout balance if needed, or put khach hang here?
        # Logic tách khách hàng bên dưới (Contract) sẽ update UI? 
        # Actually logic tách KH depends on Contract input. 
        # In FI, we put placeholder here? No, in FI it was:
        # col_new3: khach_hang_preview
        pass 
    ...
    # Hàng 4: User | Suffix (Chuyển xuống dưới vì ít sửa)
