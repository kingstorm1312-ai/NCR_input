...
def load_master_data():
    try:
        ...
        # Filter errors for 'DV_NPL' group + 'chung'
...
with st.expander("📝 Thông tin Phiếu (Header)", expanded=not st.session_state.header_locked):
    ...
    with c1:
        ...
        # NCR Logic
        # New format requested: DVNPL-mm-xx
        dept_prefix = "DVNPL"
    ...
    # Phân loại
    phan_loai = st.selectbox("Phân loại", ["", "BXD", "Chỉ", "Cuộn foam", "Cuộn lưới", "Cuộn VKD", "Dây đai", "Dây dù", "Dây kéo, đầu kéo", "Dây viền", "Dây rút", "Dây nẹp", "Đế nhựa", "Giấy carton", "Túi giấy", "Giấy tấm pallet", "Dây thun", "Dây Thừng", "Cuộn in", "Khay", "Hộp", "Manh", "Nắp", "Nẹp", "Nhựa", "Nút", "Ống nhựa", "Tấm lót", "Tấm nhựa", "Tem", "Thùng", "Túi poly", "Túi pp"], disabled=disable_hd)
