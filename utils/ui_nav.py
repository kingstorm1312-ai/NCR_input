...
MENU_STRUCTURE = [
    ...
    },
    {
        ...
        "items": [
             ...
             {"label": "Xưởng may 1", "path": DEPARTMENT_PAGES["may_i"], "departments": ["may_i"]},
             {"label": "Xưởng may P2", "path": DEPARTMENT_PAGES["may_p2"], "departments": ["may_p2"]},
             {"label": "Xưởng may N4", "path": DEPARTMENT_PAGES["may_n4"], "departments": ["may_n4"]},
             {"label": "Xưởng may A2", "path": DEPARTMENT_PAGES["may_a2"], "departments": ["may_a2"]},
